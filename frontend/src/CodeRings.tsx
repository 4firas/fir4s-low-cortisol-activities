...
const TEXT_LINES = [
  ...
  '<AllWorkAndNoPlayMakesFir4sADullBoy /><AllWorkAndNoPlayMakesFir4sADullBoy /><AllWorkAndNoPlayMakesFir4sADullBoy /><AllWorkAndNoPlayMakesFir4sADullBoy />',
...
function createTextCanvas(): [HTMLCanvasElement | null, () => void] {
  ...
  const redrawCanvas = () => {
    ...
    context.fillStyle = colors.darkGoldenrod;
...
}:
{
  ...
  return (
    <animated.group scale={scale}>
      {/* @ts-ignore drei Cylinder attachArray type issue */}
      <Cylinder

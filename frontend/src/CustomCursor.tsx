...
const CustomCursorRenderer = ({ cursor }:{cursor:CustomCursorState}) => {
  ...
  return (
    <div
      style={{
        filter: textCursor ? 'drop-shadow(0 0 0.2rem rgba(0,0,0,0.5)) drop-shadow(0 0 0.1rem rgba(0,0,0,0.3))' : 'drop-shadow(0 0 0.2rem rgba(0,0,0,0.5)) drop-shadow(0 0 0.1rem rgba(0,0,0,0.3))',
      }}
    >
      ...
      <div
        className={`
          ...
          font-mono text-blueSlate text-center leading-[1] text-[12px]
          ...
          bg-pitchBlack rounded-full border-[5px] border-darkGoldenrod
        `}
      >
        {cursor === 'computer-on' && (
          <>
